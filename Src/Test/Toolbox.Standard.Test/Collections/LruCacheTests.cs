...
namespace Toolbox.Standard.Test.Collections
{
    ...
    public class LruCacheTests
    {
        ...
        public void LruSimpleTest()
        {
            ...
            Enumerable.Range(0, count).ForEach(x => cache.Set(x, x));
        ...
        public void LruCapacityTest()
        {
            ...
            foreach (var test in variations)
            {
                ...
                Enumerable.Range(0, test.Count).ForEach(x => cache.Set(x, x));
        ...
        public void LruLinkListTest()
        {
            ...
            Enumerable.Range(0, capacity).ForEach(x => cache.Set(x, x));
            ...
            newList.ForEach(x => cache.TryGetValue(x, out int value));

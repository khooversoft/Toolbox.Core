...
namespace Khooversoft.Toolbox.Standard
{
    public class FunctionHost : IDisposable
    {
        ...
        public FunctionHost(IEnumerable<FunctionInfo> functionInfos, IServiceContainer? serviceContainer)
        {
            ...
            object construct(Type type) => serviceContainer switch { IServiceContainer c => c.GetService(type), _ => Activator.CreateInstance(type) };
        }

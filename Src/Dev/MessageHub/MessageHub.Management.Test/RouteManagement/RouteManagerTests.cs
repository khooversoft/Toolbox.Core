...
namespace MessageHub.Management.Test.RouteManagement
{
    public class RouteManagerTests
    {
        ...
        private IContainer CreateContainer()
        {
            ...
            builder.Register(x => {
                return new ActorConfigurationBuilder()
                    .Set(_workContext!)
                    .Register<INodeRegistrationActor>()
                    .Register<IQueueManagementActor>()
                    .Register<INodeRegistrationManagementActor>()
                    .Build();
            }).As<ActorConfiguration>().InstancePerLifetimeScope();
